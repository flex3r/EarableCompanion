...
sealed class SensorDataOverviewItem {
    ...
    data class Data(val id: Long, val title: String, val description: String, val createdAt: LocalDateTime, val stoppedAt: LocalDateTime?, val duration: Duration?, val entryCount: Int) : SensorDataOverviewItem() {

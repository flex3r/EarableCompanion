...
object MockData {
    ...
    fun sensorDataEntriesAndItems(name: String, address: String) = listOf(
        SensorDataEntry(deviceName = name,
            deviceAddress = address,
            timestamp = LocalDateTime.now(),
            accX = -0.010498046875,
            accY = 0.077880859375,
            accZ = 0.9921875,
            gyroX = -0.183206106870229,
            gyroY = 1.2061068702290076,
            gyroZ = -0.4122137404580153,
            heartRate = 65,
        ...
        SensorDataEntry(deviceName = name,
            deviceAddress = address,
            timestamp = LocalDateTime.now(),
            accX = -0.0098876953125,
            accY = 0.0760498046875,
            accZ = 0.991943359375,
            gyroX = -0.5801526717557252,
            gyroY = 0.07633587786259542,
        ...
        SensorDataEntry(deviceName = name,
            ...
            accX = -0.012451171875,
            accY = 0.079833984375,
            accZ = 0.9952392578125,
            gyroX = -0.42748091603053434,
            gyroY = 1.3282442748091603,
            gyroZ = 3.6030534351145036,
            heartRate = 49,
            bodyTemperature = 37.1,
            oxygenSaturation = 0.94,
            pulseRate = 49.0)
    ) to listOf(
        SensorDataDetailItem.Chart(name,
            address,
            SensorDataType.ACC_X,
            listOf(Entry(0.toFloat(), (-0.010498046875).toFloat()), Entry(1.toFloat(), (-0.0098876953125).toFloat()), Entry(2.toFloat(), (-0.012451171875).toFloat()))),
        ...
        SensorDataDetailItem.Chart(name,
            ...
            listOf(Entry(0f, (-0.183206106870229).toFloat()), Entry(1f, (-0.5801526717557252).toFloat()), Entry(2f, (-0.42748091603053434).toFloat()))),
        SensorDataDetailItem.Chart(name,
            address,
            SensorDataType.GYRO_Y,
            listOf(Entry(0f, (1.2061068702290076).toFloat()), Entry(1f, (0.07633587786259542).toFloat()), Entry(2f, (1.3282442748091603).toFloat()))),
        SensorDataDetailItem.Chart(name,
            address,
            SensorDataType.GYRO_Z,
            listOf(Entry(0f, (-0.4122137404580153).toFloat()), Entry(1f, (-0.44274809160305345).toFloat()), Entry(2f, (3.6030534351145036).toFloat()))),
